...
import { ProcessPaymentInputDto, ProcessPaymentOuputDto } from "./process-payment.dto";
...
export default class ProcessPaymentUseCase implements UseCaseInterface {
    ...
    async execute(input: ProcessPaymentInputDto): Promise<ProcessPaymentOuputDto> {
